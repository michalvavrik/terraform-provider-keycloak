...
// Issue #1395: when default_scopes references a scope that does not exist in the realm,
// the provider should return an error instead of silently ignoring it (which causes permanent drift).
