	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// import and verify state matches (headers populated by import even though not in config)
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"security_defenses_configured", "security_defenses.0.headers.#", "security_defenses.0.headers.0.%", "security_defenses.0.headers.0.content_security_policy", "security_defenses.0.headers.0.content_security_policy_report_only", "security_defenses.0.headers.0.referrer_policy", "security_defenses.0.headers.0.strict_transport_security", "security_defenses.0.headers.0.x_content_type_options", "security_defenses.0.headers.0.x_frame_options", "security_defenses.0.headers.0.x_robots_tag", "security_defenses.0.headers.0.x_xss_protection"},
			},
		},
	})
}
